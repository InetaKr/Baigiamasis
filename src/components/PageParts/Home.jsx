    ...
    return (
        ...
        <div className="landing-page-container">
            <div className="landing-page-header">
                ...
                <p>Pawzly focuses on providing pets owner with knowledge that will provide healthier lives of their pets. <br /> Moreover pet owners around the globe will be able to share their own experiences </p>
            </div>
            ...
            <div className="landing-page-feature">
                ...
                <div className="feature-text">
                    ...
                    <p>Read, Ask questions and <br /> Share the Love </p>
                </div>
                </div>
            </div>
            </div>    
